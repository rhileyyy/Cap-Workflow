...
// ============================================================================
// All prompt builders inlined here to avoid Next.js stale module cache issues.
// When lib/prompts.js is imported, Vercel sometimes serves a cached compiled
// version that doesn't include recent changes — causing "not a function" errors.
// Keeping everything in one file eliminates cross-module cache staleness.
// ============================================================================
