...
function buildAutoPrompt(s) {
  ...
  const parts = [
    ...
    'Image 1 is the front logo. Embroider Image 1 on the crown EXACTLY as shown — Precise/Accurate, In-Depth, same shapes, same text, same proportions, same colours. Do NOT redraw, Add, reinvent, simplify or substitute any part of Image 1.',
    sideInstruction,
